...
import * as dashboard from "../pages/dashboard.js?v=opsreports2";
import * as products from "../pages/products.js?v=opsreports2";
import * as suppliers from "../pages/suppliers.js?v=opsreports2";
import * as purchaseOrders from "../pages/purchaseOrders.js?v=opsreports2";
import * as receiving from "../pages/receiving.js?v=opsreports2";
import * as inventory from "../pages/inventory.js?v=opsreports2";
import * as scanner from "../pages/scannerTest.js?v=opsreports2";
import * as amazon from "../pages/amazon.js?v=opsreports2";
import * as reports from "../pages/reports.js?v=opsreports2";
import * as admin from "../pages/admin.js?v=opsreports2";
